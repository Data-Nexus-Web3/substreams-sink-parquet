module github.com/streamingfast/substreams-sink-parquet
...
replace github.com/streamingfast/dstore => github.com/dfuse-io/dstore v0.1.1-0.20250609173504-95368d3441ee
